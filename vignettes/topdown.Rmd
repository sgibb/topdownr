...
3. Replace `C:\Thermo\Instruments\TNG\OrbitrapFusionLumos\2.1\System\programs\Thermo.TNG.Calcium.MethodXML.dll` with `Thermo.TNG.Calcium.MethodXML.dll`.
