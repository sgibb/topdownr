...
list.files(topdowndata::h2aPath())
lapply(topdown:::.listTopDownFiles(topdowndata::h2aPath()), function(x) {
         c(head(x, 2), "...")
})
```
...
tds[, tds$File == "h2a_560_ETDReagentTarget_1e+06_1"]

# select all "c" fragments from a single file
tds["c", tds$File == "h2a_560_ETDReagentTarget_1e+06_1"]
```
