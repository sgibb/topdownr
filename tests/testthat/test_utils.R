...
test_that(".massLabelToId", {
    expect_equal(topdown:::.massLabelToId(c("750.0001", "1000.8245")),
                 c(1, 245))
    expect_equal(topdown:::.massLabelToId(c("750.001", "1000.824"), 2),
                 c(1, 24))
...
test_that(".medianIonInjectionTime", {
    ...
    expect_error(topdown:::.medianIonInjectionTime(data.frame(foo=1:3,
                                                              bar=1:3)))
...
test_that(".snippet", {
    ...
    expect_equal(topdown:::.snippet(c(l, L), 10), c("abcd...xyz",
                                                    "ABCD...XYZ"))
    expect_equal(topdown:::.snippet(c(l, L), 11), c("abcd...wxyz",
                                                    "ABCD...WXYZ"))
})
