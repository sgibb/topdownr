...
#' dataset available in [topdownrdata::topdownrdata-package].
#'
...
#' ```
#'
#' @format A [TopDownSet-class] with 2700 fragments and 351 conditions.
#' @source Subset taken from the [topdownrdata::topdownrdata-package] package.
"tds"
